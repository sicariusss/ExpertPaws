        ...
        <div class="col-lg-5">
            <div class="row py-lg-5 mx-1 show-data">
                ...
                @if($product->getDescription() !== null)
                    <div>
                        <span><i
                                class="fa-solid fa-chevron-right"></i> Описание:</span> {{ $product->getDescription() }}
                    </div>
                @endif
                ...
                @if($product->getManufacturer() !== null)
                    <div>
                        <span><i
                                class="fa-solid fa-chevron-right"></i> Производитель:</span> {{ $product->getManufacturer() }}
                    </div>
                @endif
                @if($product->getCategory() !== null)
                    <div>
                        <span><i
                                class="fa-solid fa-chevron-right"></i> Категория:</span> {{ $product->getCategory()->getName() }}
                    </div>
                @endif
            </div>
        </div>
